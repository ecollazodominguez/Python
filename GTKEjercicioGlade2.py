...
class Fiestra(Gtk.Window):
    def __init__(self):
        ...
        builder = Gtk.Builder()
        builder.add_from_file("EjercicioInterfaz2GLADE.glade")
    ...
    def on_txtDende_activate(self, entry):
        """ Método do sinal activate do control txtDende.

        Este método recolle o texto no Gtk.Entry txtDende e o inserta no Gtk.ComboBox
        cmbDende.

        :param entry: Orixe do voo
        :return None:
        """
